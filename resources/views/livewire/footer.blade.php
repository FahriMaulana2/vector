<footer class="bg-[#0B5ED7] text-white">
    <div class="max-w-7xl mx-auto px-6 lg:px-8 py-16">
        <div class="grid gap-12 lg:grid-cols-[1.3fr_0.9fr_0.9fr_0.9fr]">
            <div class="space-y-5">
                <div class="inline-flex items-center gap-3">
                    <div class="flex h-12 w-12 items-center justify-center rounded-3xl bg-white text-[#0B5ED7] font-bold">P</div>
                    <div>
                        <p class="font-semibold uppercase tracking-[0.3em]">Printify</p>
                        <p class="text-sm text-white/80">Digital Printing</p>
                    </div>
                </div>
                <p class="max-w-sm text-sm leading-6 text-white/80">Menyediakan layanan printing profesional untuk branding, promosi, dan material bisnis dengan kualitas unggul.</p>
            </div>
            <div>
            ...
            <div>
                <p class="text-sm font-semibold uppercase tracking-[0.3em] text-white/80">Working Hours</p>
                <div class="mt-6 space-y-3 text-sm text-white/80">
        ...
        <div class="mt-12 border-t border-white/10 pt-8 text-sm text-white/60">© 2026 Printify Studio. All rights reserved.</div>
    </div>
</footer>
