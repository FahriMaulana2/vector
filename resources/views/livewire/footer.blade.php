...
$mapsEmbedUrl = Setting::getGoogleMaps();
?>
...
<footer class="relative overflow-hidden bg-gradient-to-br from-navy-dark via-navy to-navy-deep text-cream">
    ...
    <div class="max-w-7xl mx-auto px-5 md:px-6 lg:px-8 pt-20 pb-10 relative z-10" data-aos="fade-up">
        <div class="grid gap-10 sm:grid-cols-2 lg:grid-cols-[1.8fr_0.9fr_0.9fr_1.4fr] lg:gap-10">
{{-- Brand Column --}}
            <div class="space-y-6">
            ...
            {{-- Spacer / removed Navigasi column intentionally --}}
...
<div class="flex items-start gap-3">
            ...
            <div class="sm:col-span-2 lg:col-span-1">
                <p class="font-heading text-xs font-semibold uppercase tracking-[0.2em] text-gold">Lokasi</p>
                <div class="mt-5">
                    @if($mapsEmbedUrl)
                        <iframe
                            src="{{ $mapsEmbedUrl }}"
