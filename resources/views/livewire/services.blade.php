...
<section id="services" class="relative overflow-hidden bg-white">
    {{-- Single subtle background --}}
    <div class="absolute inset-0 pointer-events-none">
        <div class="absolute top-1/3 left-0 w-[450px] h-[450px] bg-gradient-to-r from-[#0B5ED7]/3 to-transparent rounded-full blur-3xl"></div>
    </div>
    ...
    <div class="max-w-7xl mx-auto px-5 md:px-6 lg:px-8 relative">
        ...
        <div class="text-center max-w-3xl mx-auto" data-aos="fade-up">
            ...
            <h2 class="text-4xl md:text-5xl lg:text-[56px] font-bold tracking-tight text-slate-950 leading-[1.1]">Solusi Cetak &amp; Branding <span class="text-[#0B5ED7]">Lengkap</span></h2>
        ...
        <div class="mt-12 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <div class="group rounded-2xl border border-slate-100 bg-white p-8 shadow-card transition-all duration-500 hover:-translate-y-1.5 hover:shadow-card-hover hover:border-[#0B5ED7]/20 flex flex-col"
                 data-aos="fade-up" data-aos-delay="{{ $service['delay'] }}">
                <div class="flex flex-col flex-1">
                    <div class="flex h-12 w-12 items-center justify-center rounded-xl bg-[#0B5ED7]/10 text-[#0B5ED7] transition-all duration-500 group-hover:bg-[#0B5ED7] group-hover:text-white">
                    ...
                    <p class="mt-2 text-sm leading-relaxed text-slate-500 flex-1">{{ $service['desc'] }}</p>
                    <a href="#contact" class="mt-5 inline-flex items-center gap-1.5 text-sm font-semibold text-[#0B5ED7] transition-all duration-300 group-hover:gap-2.5">
                        Selengkapnya
