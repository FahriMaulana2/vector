...
<section id="services" class="relative overflow-hidden bg-light">
    ...
    <div class="absolute inset-0 pointer-events-none">
        ...
        <div class="absolute bottom-0 right-0 w-[280px] h-[280px] md:w-[400px] md:h-[400px] bg-gradient-to-l from-white/50 to-transparent rounded-full blur-3xl"></div>
    </div>
    ...
    <div class="mx-auto px-4 md:px-6 lg:px-8 py-12 md:py-20 lg:py-24 relative z-10 md:max-w-7xl">
        ...
        <div class="text-center max-w-3xl mx-auto" data-aos="fade-up">
            <span class="inline-flex items-center gap-2 rounded-full bg-white px-3 py-1.5 md:px-4 md:py-1.5 border border-gold/30 shadow-soft mb-4 md:mb-6">
                ...
                <span class="font-heading text-[10px] md:text-xs font-semibold uppercase tracking-[0.15em] md:tracking-[0.22em] text-navy">Layanan Kami</span>
            </span>
            <h2 class="font-heading text-xl md:text-4xl lg:text-5xl font-bold tracking-tight text-navy leading-tight md:leading-[1.1]">Solusi Kreatif untuk Kebutuhan <span class="gradient-text">Bisnis Anda</span></h2>
            <p class="mt-3 md:mt-4 max-w-2xl mx-auto text-sm md:text-base lg:text-lg font-inter leading-relaxed text-ink-soft">Dari kebutuhan cetak harian hingga branding korporat, kami siap mewujudkannya dengan hasil terbaik.</p>
        </div>
        ...
        <div class="mt-8 md:mt-14 grid gap-3 md:gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 items-start" id="services-grid">
            ...
            @empty
            <p class="text-center text-xs md:text-sm font-inter text-ink-soft col-span-full py-8">Belum ada layanan yang tersedia.</p>
            @endforelse
        </div>
    </div>
</section>
