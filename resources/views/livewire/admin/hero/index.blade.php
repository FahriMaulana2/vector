                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <div class="mt-4 pt-4 border-t border-border/70 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <button type="button"
                                        @click="$dispatch('confirm-delete', { id: {{ $hero->id }}, componentId: $wire.__instance.id, action: 'delete' })"
                                        class="inline-flex items-center gap-1.5 px-3.5 py-2 rounded-lg text-sm font-medium text-red-600 bg-red-50 hover:bg-red-100 transition-colors cursor-pointer">
