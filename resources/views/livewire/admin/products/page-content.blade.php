<div class="space-y-6">
        ...
        <div>
            <nav class="mb-2 flex text-sm text-slate-500" aria-label="Breadcrumb">
                <ol class="inline-flex items-center gap-2">
                    ...
                    <li class="font-medium text-[#0F2747]" aria-current="page">Halaman Produk</li>
                </ol>
            </nav>
            <h1 class="text-2xl font-bold text-[#182B3A]">Halaman Produk</h1>
            <p class="mt-1 text-sm text-slate-500">Kelola teks dan konten halaman /products.</p>
        </div>
        <button type="submit" form="products-page-content-form" wire:loading.attr="disabled" class="inline-flex items-center justify-center rounded-xl bg-blue-600 px-5 py-3 text-sm font-semibold text-white shadow-sm transition hover:bg-blue-700 disabled:cursor-wait disabled:opacity-60">
    ...
    <form id="products-page-content-form" wire:submit="save" class="space-y-6">
        <section class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
            <div class="mb-5">
                <h2 class="text-base font-semibold text-[#182B3A]">Hero Section</h2>
                <p class="mt-1 text-sm text-slate-500">Teks pembuka yang tampil di bagian atas halaman produk.</p>
            </div>
        ...
        <section class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
            <div class="mb-5">
                ...
                <p class="mt-1 text-sm text-slate-500">Pesan utama dan penjelasan singkat di bawah grid produk.</p>
            </div>
            <div class="space-y-5">
                <div>
