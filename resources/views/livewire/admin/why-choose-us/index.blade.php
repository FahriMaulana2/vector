<div>
    <div class="mb-6">
        <div class="flex items-center justify-between flex-wrap gap-4">
            <div>
                <h1 class="text-2xl lg:text-3xl font-bold text-text-primary admin-heading">Mengapa Memilih Kami</h1>
                <p class="text-text-secondary mt-1.5 text-sm">Kelola keunggulan perusahaan.</p>
            </div>
            <a href="{{ route('admin.why-choose-us.create') }}" wire:navigate class="inline-flex items-center gap-2 px-5 py-2.5 bg-primary text-white text-sm font-semibold rounded-xl hover:bg-primary-dark transition-all duration-200 shadow-button hover:shadow-button-hover">
        ...
        <div class="p-6">
            @if($items->isEmpty())
                <div class="text-center py-12">
                    ...
                    <a href="{{ route('admin.why-choose-us.create') }}" wire:navigate class="inline-flex items-center gap-2 mt-4 px-4 py-2 bg-primary text-white text-sm font-medium rounded-xl hover:bg-primary-dark transition-colors">Tambah</a>
                </div>
            @else
