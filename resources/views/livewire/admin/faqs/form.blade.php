    ...
    <div class="mb-6">
        <div class="flex items-center justify-between flex-wrap gap-4">
            <div>
                ...
                <p class="text-text-secondary mt-1.5 text-sm">Kelola pertanyaan umum.</p>
            </div>
        ...
        <div class="bg-white rounded-2xl border border-border shadow-soft p-6">
            <div class="space-y-4">
                <div>
                    ...
                    <input wire:model="question" type="text" class="w-full px-4 py-2.5 border border-border rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all" placeholder="Pertanyaan">
                ...
                <div>
                    ...
                    <textarea wire:model="answer" rows="4" class="w-full px-4 py-2.5 border border-border rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all resize-none" placeholder="Jawaban"></textarea>
                ...
                <div>
                    ...
                    <input wire:model="order" type="number" min="0" class="w-full px-4 py-2.5 border border-border rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all" placeholder="0">
                </div>
