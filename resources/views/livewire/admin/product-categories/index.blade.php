<div>
    <div class="mb-6">
        <div class="flex items-center justify-between flex-wrap gap-4">
            <div>
                <h1 class="text-2xl lg:text-3xl font-bold text-text-primary admin-heading">Kategori Produk</h1>
                <p class="text-text-secondary mt-1.5 text-sm">Kelola kategori produk.</p>
            </div>
            <a href="{{ route('admin.product-categories.create') }}" wire:navigate class="inline-flex items-center gap-2 px-5 py-2.5 bg-primary text-white text-sm font-semibold rounded-xl hover:bg-primary-dark transition-all duration-200 shadow-button hover:shadow-button-hover">
        ...
        <div class="p-6">
            @if($items->isEmpty())
                <div class="text-center py-12">
                    ...
                    <a href="{{ route('admin.product-categories.create') }}" wire:navigate class="inline-flex items-center gap-2 mt-4 px-4 py-2 bg-primary text-white text-sm font-medium rounded-xl hover:bg-primary-dark transition-colors">Tambah</a>
                </div>
            @else
                    ...
                    <table class="w-full text-sm">
                        <thead>
                            <tr class="border-b border-border">
                                ...
                                <th class="text-left py-3.5 px-3 text-xs font-semibold text-text-secondary uppercase tracking-wider">Slug</th>
                        ...
                        <tbody>
                            ...
                            <tr class="border-b border-border/50 hover:bg-surface/50 transition-colors">
                                ...
                                <td class="py-4 px-3"><span class="text-sm text-text-secondary">{{ $item->slug }}</span></td>
                                <td class="py-4 px-3">
