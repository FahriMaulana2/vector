    ...
    <nav class="fixed bottom-0 left-0 right-0 md:hidden bg-white border-t border-gray-200 shadow-lg z-50 safe-area-inset-bottom" role="navigation" aria-label="Mobile Navigation">
        <div class="flex items-stretch">
            ...
            <a href="{{ route('home') }}" wire:navigate
               class="flex-1 flex flex-col items-center justify-center py-3 px-2 text-center no-underline transition-colors duration-200 group">
            ...
            <a href="{{ route('about') }}" wire:navigate
               class="flex-1 flex flex-col items-center justify-center py-3 px-2 text-center no-underline transition-colors duration-200 group">
                ...
                <span class="text-[10px] font-inter font-medium text-gray-600 group-hover:text-navy">Tentang</span>
            </a>
