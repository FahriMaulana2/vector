                        ...
                        <div class="flex flex-col flex-1 p-3">
                            ...
                            <div class="mt-3 flex items-center">
                                <button type="button"
                                   ...
                                   class="group/btn inline-flex w-full items-center justify-center gap-2 rounded-lg bg-navy px-3 py-2 text-[11px] font-heading font-semibold text-white transition-all duration-300 hover:bg-navy-deep hover:shadow-button-hover active:translate-y-0 focus:outline-none focus-visible:ring-2 focus-visible:ring-gold/50 cursor-pointer">
                                    <svg class="w-3 h-3 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z"/></svg>
                                    <span>Order</span>
                                </button>
                            </div>
                        </div>
