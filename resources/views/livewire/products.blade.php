...
<div class="max-w-7xl mx-auto px-5 md:px-6 lg:px-8 py-20 lg:py-24 relative z-10">
        ...
        {{-- Bottom CTA (dikontrol admin via setting show_product_cta) --}}
        @if($showProductCta)
        <div class="mt-14" data-aos="fade-up">
            <div class="relative rounded-[1.75rem] bg-white border border-white/70 p-10 lg:p-14 text-center shadow-card overflow-hidden">
                ...
                <div class="max-w-xl mx-auto relative z-10">
                    <h3 class="font-heading text-2xl lg:text-3xl font-bold text-navy">Explore Our Complete Product Catalogue</h3>
                    <p class="mt-3 text-base font-inter text-ink-soft leading-relaxed">We provide hundreds of digital printing, promotional, and branding products for businesses, events, and personal needs.</p>
                    <div class="mt-6">
                        <a href="/products"
                           class="group inline-flex items-center gap-2.5 rounded-full border-2 border-navy bg-transparent px-8 py-3.5 text-sm font-heading font-semibold text-navy transition-all duration-300 hover:bg-gold hover:border-gold hover:text-navy hover:shadow-button-hover hover:-translate-y-0.5 active:translate-y-0 focus:outline-none focus-visible:ring-2 focus-visible:ring-gold/50">
                            ...
                            <svg class="w-4 h-4 text-gold-dark transition-transform duration-300 group-hover:translate-x-1" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M17 8l4 4m0 0l-4 4m4-4H3"/></svg>
                        </a>
                    </div>
                </div>
            </div>
