<section id="contact" class="bg-white py-24">
    <div class="max-w-7xl mx-auto px-6 lg:px-8">
        <div class="grid gap-14 xl:grid-cols-[0.95fr_1.05fr] lg:items-start">
            <div class="space-y-8">
                ...
                <div class="space-y-6 rounded-[2rem] border border-slate-200 bg-[#F8FAFC] p-8 shadow-xl shadow-slate-200/40">
                    <div class="flex items-start gap-4">
                        <div class="mt-1 flex h-11 w-11 items-center justify-center rounded-3xl bg-[#0B5ED7]/10 text-[#0B5ED7]">
            ...
            <div class="rounded-[2rem] border border-slate-200 bg-[#F8FAFC] p-8 shadow-xl shadow-slate-200/40">
                ...
                <form class="mt-8 space-y-6">
                    <div class="grid gap-6 sm:grid-cols-2">
                        <label class="block">
                            ...
                            <input type="text" placeholder="Nama Anda" class="mt-2 w-full rounded-3xl border border-slate-300 bg-white px-4 py-3 text-sm text-slate-900 outline-none transition focus:border-[#0B5ED7] focus:ring-2 focus:ring-[#0B5ED7]/20" />
                        </label>
                        <label class="block">
                            <span class="text-sm font-semibold text-slate-700">Email</span>
                            <input type="email" placeholder="Email Anda" class="mt-2 w-full rounded-3xl border border-slate-300 bg-white px-4 py-3 text-sm text-slate-900 outline-none transition focus:border-[#0B5ED7] focus:ring-2 focus:ring-[#0B5ED7]/20" />
                        </label>
                    </div>
                    <label class="block">
                        <span class="text-sm font-semibold text-slate-700">Service</span>
                        <select class="mt-2 w-full rounded-3xl border border-slate-300 bg-white px-4 py-3 text-sm text-slate-900 outline-none transition focus:border-[#0B5ED7] focus:ring-2 focus:ring-[#0B5ED7]/20">
                    ...
                    <label class="block">
                        ...
                        <textarea rows="5" placeholder="Tulis pesan Anda" class="mt-2 w-full rounded-3xl border border-slate-300 bg-white px-4 py-3 text-sm text-slate-900 outline-none transition focus:border-[#0B5ED7] focus:ring-2 focus:ring-[#0B5ED7]/20"></textarea>
                    </label>
                    <button type="button" class="w-full rounded-full bg-[#0B5ED7] px-6 py-4 text-sm font-semibold text-white transition hover:bg-[#0a4dc2]">Send Message</button>
                </form>
            </div>
        </div>
    </div>
