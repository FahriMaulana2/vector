...
<section id="kontak" class="relative overflow-hidden bg-cream py-12 md:py-20 lg:py-28">
    ...
    <div class="mx-auto px-4 md:px-6 lg:px-8 relative z-10 md:max-w-7xl">
        ...
        <div class="text-center max-w-3xl mx-auto" data-aos="fade-up" wire:ignore.self>
            <span class="inline-flex items-center gap-2 rounded-full bg-white px-3 py-1.5 md:px-4 md:py-1.5 border border-gold/30 shadow-soft">
                ...
                <span class="font-heading text-[10px] md:text-xs font-semibold uppercase tracking-[0.15em] md:tracking-[0.22em] text-navy">Hubungi &amp; Temukan Kami</span>
            </span>
        ...
        <div class="mt-8 md:mt-14 grid gap-6 md:gap-10 lg:grid-cols-[1fr_1fr] lg:items-stretch">
            ...
            {{-- Right: Lokasi & Kanal Kontak Cepat --}}
            <div class="rounded-lg md:rounded-[1.75rem] border border-gold/20 bg-white p-4 md:p-8 lg:p-10 shadow-card transition-all duration-300 hover:shadow-card-hover flex flex-col" data-aos="fade-left" wire:ignore.self>
                <div class="flex items-center gap-2 md:gap-3 mb-4 md:mb-6">
                    ...
                    <div>
                        <p class="font-heading text-[10px] md:text-xs font-semibold uppercase tracking-[0.12em] md:tracking-[0.2em] text-gold-dark">Lokasi &amp; Konsultasi</p>
                        <h3 class="font-heading text-sm md:text-xl font-bold text-navy">Kunjungi atau Chat Tim Kami</h3>
                        <p class="text-[10px] md:text-sm font-inter text-ink-soft">Konsultasi bahan, ukuran, dan estimasi harga tanpa biaya</p>
                    </div>
                </div>

                {{-- Maps Placeholder (preserved) --}}
                <div class="rounded-lg md:rounded-2xl overflow-hidden border border-gold/15 shadow-soft">
                ...
                <div class="mt-3 md:mt-4">
                    <a href="{{ route('products.index') }}" wire:navigate
                       class="group flex items-center justify-center gap-2 md:gap-3 rounded-full border border-navy/15 bg-cream px-4 md:px-8 py-3 md:py-4 text-xs md:text-sm font-heading font-semibold text-navy transition-all duration-300 hover:border-gold hover:bg-white hover:-translate-y-0.5 active:translate-y-0">
                        <span>Lihat Katalog &amp; Pesan Sekarang</span>
                        <svg class="w-3 h-3 md:w-4 md:h-4 text-gold transition-transform duration-300 group-hover:translate-x-1" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M17 8l4 4m0 0l-4 4m4-4H3"/></svg>
                    </a>
                </div>
            </div>
        </div>

        {{-- Official Marketplace (digabung dengan area kontak) --}}
