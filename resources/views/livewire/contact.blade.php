                ...
                <form class="space-y-5 flex-1">
                    ...
                    <div class="grid gap-5 sm:grid-cols-2">
                        <div>
                            ...
                            <input id="contact-name" type="text" name="name" placeholder="Masukkan nama Anda"
                                   class="w-full rounded-xl border border-gold/25 bg-cream px-4 py-3.5 text-sm font-inter text-navy outline-none transition-all duration-300 placeholder:text-ink-soft/60 focus:bg-white focus:border-gold focus:ring-2 focus:ring-gold/20 hover:border-gold/40" />
                        </div>
                        <div>
                            <label for="contact-phone" class="block text-sm font-heading font-semibold text-navy mb-1.5">No. WhatsApp</label>
                            <input id="contact-phone" type="tel" name="phone" placeholder="+62 812-xxxx-xxxx"
                                   class="w-full rounded-xl border border-gold/25 bg-cream px-4 py-3.5 text-sm font-inter text-navy outline-none transition-all duration-300 placeholder:text-ink-soft/60 focus:bg-white focus:border-gold focus:ring-2 focus:ring-gold/20 hover:border-gold/40" />
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <input id="contact-email" type="email" name="email" placeholder="contoh@email.com"
                               class="w-full rounded-xl border border-gold/25 bg-cream px-4 py-3.5 text-sm font-inter text-navy outline-none transition-all duration-300 placeholder:text-ink-soft/60 focus:bg-white focus:border-gold focus:ring-2 focus:ring-gold/20 hover:border-gold/40" />
                    </div>
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-2 gap-2">
                            ...
                            <label class="group flex items-center gap-2.5 rounded-xl border border-gold/25 bg-cream px-3.5 py-2.5 cursor-pointer transition-all duration-200 hover:border-gold/50 hover:bg-white focus-within:ring-2 focus-within:ring-gold/20">
                                <input type="radio" name="service" value="{{ $service }}" class="h-4 w-4 accent-gold">
                                <span class="text-sm font-inter text-ink-soft group-hover:text-navy">{{ $service }}</span>
                            </label>
                            @endforeach
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea id="contact-message" rows="4" name="message" placeholder="Jelaskan kebutuhan cetak atau branding Anda..."
                                  class="w-full rounded-xl border border-gold/25 bg-cream px-4 py-3.5 text-sm font-inter text-navy outline-none transition-all duration-300 placeholder:text-ink-soft/60 focus:bg-white focus:border-gold focus:ring-2 focus:ring-gold/20 hover:border-gold/40 resize-none"></textarea>
                    </div>

                    {{-- Submit Button --}}
                    <button type="submit"
                            class="group relative w-full rounded-full bg-navy px-6 py-4 text-sm font-heading font-semibold text-cream shadow-button transition-all duration-300 hover:bg-navy-deep hover:shadow-button-hover hover:-translate-y-0.5 active:translate-y-0 overflow-hidden">
