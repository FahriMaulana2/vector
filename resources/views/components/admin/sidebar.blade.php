...
'KELOLA WEBSITE' => [
                    ...
                    ['name' => '↳ Statistik', 'route' => 'admin.about.stats.index', 'active_routes' => ['admin.about.stats.index', 'admin.about.stats.create', 'admin.about.stats.edit'], 'icon' => 'bar-chart', 'badge' => null],
                    ['name' => '↳ Timeline/Milestone', 'route' => 'admin.about.milestones.index', 'active_routes' => ['admin.about.milestones.index', 'admin.about.milestones.create', 'admin.about.milestones.edit'], 'icon' => 'clock', 'badge' => null],
