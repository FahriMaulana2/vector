...
class AboutSectionSeeder extends Seeder
{
    ...
    {
        AboutSection::create([
            'title' => 'Tentang OMAH Vector',
            'subtitle' => 'Mitra Branding & Printing Profesional',
            'description' => 'OMAH Vector adalah perusahaan yang bergerak di bidang digital printing, graphic design, dan corporate branding. Kami berkomitmen memberikan hasil cetak berkualitas tinggi dengan pelayanan terbaik untuk mendukung kesuksesan bisnis Anda.',
